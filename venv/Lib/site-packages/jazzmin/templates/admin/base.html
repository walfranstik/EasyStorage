    ...
    {% if not is_popup %}
        <nav class="main-header navbar navbar-expand {{ jazzmin_ui.navbar_classes }}" id="jazzy-navbar">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                {% endif %}
                <li style="width: 60vw; ">
                    <a href="{% url 'almacen:index_admin' %}" style="color: #a2a2a2; text-decoration: none;">
                    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
                    <span class="material-symbols-outlined" style="display: block; margin: 5px auto 5px 30%; font-size:40px;">
                        query_stats
                    </span>
                    </a>
                </li>
